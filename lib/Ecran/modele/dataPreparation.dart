...
class DataPreparation {
  Future<Top1000> chargeArticle() async {
    ...
    Top1000 prep7 = Top1000.id(7, "P07", "Citron Barre", "54468951245", 2000, "C07", "test6", "950146014577", 0, 0, "", 1);
    Top1000 prep8 = Top1000.id(8, "P08", "Nougat", "54446895125", 18230, "C08", "tes7", "95010462536", 0, 0, "", 1);
    Top1000 prep9 = Top1000.id(9, "P09", "Vodka", "66566356568", 12000, "C09", "test8", "950104601898", 0, 0, "", 1);

    List data = [prep1, prep2, prep3, prep4, prep5, prep6, prep7, prep8, prep9, prep10];
